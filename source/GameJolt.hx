...
{    
     ...
     */
    public static var changeState:FlxUIState = new WarningSubState();
    /**
    ...
    */
    ...
    public static var textArray:Array<String> = [
        "I went downstairs to get a glass of water. Then, I realized Freddy Fazbear was in the room. -Tigression",
        "among us is not real, get over it -Ekical",
        "IVE POISONED THE WATER SUPPLY HE-MAN -tailsfan01",
        "i fuccking hate this dev server -chromasen",
        "I HATE Dave & Bambi. -GenoX",
        "sex -armandronan",
        "whats fuck -sic",
        "amogus -YaWill"
    ];
