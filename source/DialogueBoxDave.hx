...
class DialogueBoxDave extends FlxSpriteGroup
{
	...
	public var noAa:Array<String> = ["updateron/portraits/dave_furiosity", "updateron/portraits/3d_bamb", "updateron/portraits/unfairnessPortrait"];
	...
	function getPortrait(character:String):Portrait
	{
		...
		switch (character)
		{
			case 'dave':
				...
				{
					case 'house':
						portrait.portraitPath = 'updateron/portraits/dave_house';
						portrait.portraitPrefix = 'dave house portrait';

					case 'insanity':
						portrait.portraitPath = 'updateron/portraits/dave_insanity';
					...
					case 'furiosity' | 'polygonized':
						portrait.portraitPath = 'updateron/portraits/dave_furiosity';
						portrait.portraitPrefix = 'dave furiosity portrait';

					case 'blocked' | 'corn-theft' | 'maze':
						portrait.portraitPath = 'updateron/portraits/dave_bambiweek';
						portrait.portraitPrefix = 'dave bambi week portrait';
					case 'splitathon':
						portrait.portraitPath = 'updateron/portraits/dave_splitathon';
			...
			case 'bambi':
				...
				{
					case 'blocked':
						portrait.portraitPath = 'updateron/portraits/bambi_blocked';
						portrait.portraitPrefix = 'bambi blocked portrait';
					case 'old-corn-theft' | 'old-maze':
						portrait.portraitPath = 'updateron/portraits/oldFarmBambiPortrait';
						portrait.portraitPrefix = 'bambienter';
					case 'corn-theft':
						portrait.portraitPath = 'updateron/portraits/bambi_corntheft';
						portrait.portraitPrefix = 'bambi corntheft portrait';
					case 'maze':
						portrait.portraitPath = 'updateron/portraits/bambi_maze';
						portrait.portraitPrefix = 'bambi maze portrait';
					case 'supernovae' | 'glitch':
						portrait.portraitPath = 'updateron/portraits/bambi_bevel';
						portrait.portraitPrefix = 'bambienter';
					case 'splitathon':
						portrait.portraitPath = 'updateron/portraits/bambi_splitathon';
						portrait.portraitPrefix = 'bambi splitathon portrait';
					case 'cheating':
						portrait.portraitPath = 'updateron/portraits/3d_bamb';
						portrait.portraitPrefix = 'bambi 3d portrait';
					case 'unfairness':
						portrait.portraitPath = 'updateron/portraits/unfairnessPortrait';
			...
			case 'bf':
				...
				{
					case 'blocked' | 'maze':
						portrait.portraitPath = 'updateron/portraits/bf_blocked_maze';
					...
					case 'furiosity' | 'polygonized' | 'corn-theft' | 'cheating' | 'unfairness' | 'supernovae' | 'glitch':
						portrait.portraitPath = 'updateron/portraits/bf_furiosity_corntheft';
						portrait.portraitPrefix = 'bf furiosity & corntheft portrait';
					case 'house':
						portrait.portraitPath = 'updateron/portraits/bf_house';
						portrait.portraitPrefix = 'bf house portrait';
					case 'insanity' | 'splitathon':
						portrait.portraitPath = 'updateron/portraits/bf_insanity_splitathon';
						portrait.portraitPrefix = 'bf insanity & splitathon portrait';
				}
				portrait.left = false;
			case 'ron':
				portrait.portraitPath = 'updateron/portraits/ron_house';
			...
			case 'gf':
				...
				{
					case 'blocked':
						portrait.portraitPath = 'updateron/portraits/gf_blocked';
						portrait.portraitPrefix = 'gf blocked portrait';
					case 'corn-theft' | 'cheating' | 'unfairness':
						portrait.portraitPath = 'updateron/portraits/gf_corntheft';
						portrait.portraitPrefix = 'gf corntheft portrait';
					case 'maze':
						portrait.portraitPath = 'updateron/portraits/gf_maze';
						portrait.portraitPrefix = 'gf maze portrait';
					case 'splitathon':
						portrait.portraitPath = 'updateron/portraits/gf_splitathon';
						portrait.portraitPrefix = 'gf splitathon portrait';
				}
				portrait.left = false;
			case 'tristan':
				portrait.portraitPath = 'updateron/portraits/tristanPortrait';
